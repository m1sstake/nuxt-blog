...
export default {
  ...
  data () {
   return {
      comments: [
        { id: 1, name: 'Alex', text: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer lacinia.', status: true },
        { id: 2, name: 'Evgenii', text: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer lacinia.', status: false}
        ],
      }
  },
  layout: 'admin',
